...
export function Home() {
    return (
        <section id='home' className="flex justify-center flex-col gap-12 pt-52 pb-8 relative">
            ...
            <h1 className='scroll-m-20 text-5xl xs:text-6xl sm:text-7xl md:text-8xl lg:mt-6 font-extrabold tracking-tight'>Olá ! Eu sou liander souza & sou desenvolvedor front-end 👋🏻</h1>
